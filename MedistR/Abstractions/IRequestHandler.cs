...
public interface IRequestHandler<in TRequest> where TRequest : IRequest<TRequest>
{
    public Task Handle(TRequest command, CancellationToken cancellationToken);
}


public interface IRequestHandler<in TRequest, TResult> where TRequest : IRequest<TRequest, TResult>
{
